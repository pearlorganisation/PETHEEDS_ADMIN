...
export default function ViewModalEnquiry ({viewData,setModal}) {
  ...
  >
    ...
    <tbody className="text-gray-600">
      <tr>
        ...
        <td className="py-2 px-4 border border-gray-300">{viewData ? viewData?.name : ''}</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td className="py-2 px-4 border border-gray-300">{viewData ? viewData?.number : ''}</td>
      </tr>
      <tr>
        <td className="py-2 px-4 border border-gray-300">Subject</td>
        <td className="py-2 px-4 border border-gray-300">{viewData ? viewData?.subject : ''}</td>
      </tr>
      <tr>
        <td className="py-2 px-4 border border-gray-300">Message</td>
        <td className="py-2 px-4 border border-gray-300">{viewData ? viewData?.message : ''}</td>
      </tr>
   \
